...
export default function DashBoard() {
  ...
  const renderWords = (words: string[]) => (
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 mb-4 ">
      {words.map((word, index) => (
        <div
          key={index}
          className="p-4 bg-[#111111] text-white rounded-lg shadow cursor-pointer transition-all duration-250 ease-in-out hover:bg-[#2c2b2b] hover:brightness-105 hover:scale-102"
  ...
  return (
    <>
      <div className="p-2 md:p-16 flex flex-col md:flex-row">
        <PhoneticsPanel
        ...
        <div className="md:w-3/4 p-4  mt-4 md:mt-12 ">
            ...
            <div className="flex flex-wrap gap-2 mb-4 sm:mb-0 sm:mr-4 w-full">
              <button
                className={`px-4 py-2 rounded flex-1 ${
                  viewMode === "all"
                    ? "bg-[#FF6B00] font-bold text-white transition-all duration-250 ease-in-out hover:brightness-110 hover:scale-103"
                    : "bg-gray-300  font-bold transition-all duration-250 ease-in-out hover:brightness-110 hover:scale-103"
                }`}
              ...
              <button
                className={`px-4 py-2 rounded flex-1 ${
                  viewMode === "favorites"
                    ? "bg-yellow-500 text-white  font-bold transition-all duration-250 ease-in-out hover:brightness-110 hover:scale-103"
                    : "bg-gray-300  font-bold transition-all duration-250 ease-in-out hover:brightness-110 hover:scale-103"
                }`}
              ...
              <button
                className={`px-4 py-2 rounded flex-1 ${
                  viewMode === "viewed"
                    ? "bg-green-500 text-white  font-bold transition-all duration-250 ease-in-out hover:brightness-110 hover:scale-103 "
                    : "bg-gray-300  font-bold transition-all duration-250 ease-in-out hover:brightness-110 hover:scale-103"
                }`}
          ...
          {displayWords.length > 0 ? (
                ...
                <button
                  ...
                  className={`p-2 rounded ${
                    currentPage > 1
                      ...
                      : "bg-gray-300 text-gray-500 cursor-not-allowed transition-all duration-250 ease-in-out hover:brightness-110 hover:scale-103"
                  }`}
                >
                  <LeftIcon />
                </button>
            ...
            <div className="text-white">No words found.</div>
          )}
        </div>
